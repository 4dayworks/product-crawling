export interface Product extends ProductDesc, ProductShopDesc, Url {
...
export interface TableProduct {
  ...
  itemscout_product_name: string | null;
  itemscout_product_image: string | null;
  itemscout_product_id: number | null;
  price: number | null;
