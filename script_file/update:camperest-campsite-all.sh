...
LOG_FILE="/home/ubuntu/product-crawling/script_file/update:camperest-campsite-all.log"
...
curl -X PATCH -H "Authorization: Bearer dirldirlvkdlxld41669197319627067" "https://node5.yagiyagi.kr/campsite/all" >> $LOG_FILE 2>&1
