...
LOG_FILE="/Users/yagiyagi/projects/dayworks4/product-crawling/script/update:product-thirthmall.log"
...
cd /Users/yagiyagi/projects/dayworks4/product-crawling && yarn update:product-thirthmall >> $LOG_FILE 2>&1
